...
import classes from "./mealPlanInsight.module.css";

const mealPlanInsight = (props) => {
  return (
    <div className={classes.ContentRow}>
      ...
      />
      <div>
        <div className={classes.ContentHeadline}>{props.contentHeadline}</div>
...
export default mealPlanInsight;
